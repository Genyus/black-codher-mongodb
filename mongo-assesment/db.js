...
const dbConnectionUrl =
  "mongodb+srv://HawaBah:pasadofuturo@cluster0test.egglq.mongodb.net/movie?retryWrites=true&w=majority";
...
// app.get("http://localhost:3000/api/films/:pageFilm", (req, res) => {
//   console.log(req.params.pageFilm);

//   const matchingPage = db.profiles[req.params.userId];
